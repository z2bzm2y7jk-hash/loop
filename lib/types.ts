...
export type Round={started?:boolean;id:string;course:string;holes:number;players:Player[];games:Game[];config:Config;results:Hole[];presses:Press[];paid:string[];date:string};
